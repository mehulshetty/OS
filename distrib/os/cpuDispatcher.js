    ...
    class CpuDispatcher {
        ...
        switchContext() {
            ...
            if (readyQueue[0].state !== "Terminated") {
                ...
                _StdOut.putText("Process " + terminatedProcess.pid + " is terminated.");
                _StdOut.advanceLine();
                _StdOut.putText("Wait Time: " + waitAndTurnaroundTimeTable[terminatedProcess.pid.toString()][0]);
                _StdOut.advanceLine();
                _StdOut.putText("Turnaround Time: " + waitAndTurnaroundTimeTable[terminatedProcess.pid.toString()][1]);
                _StdOut.advanceLine();
                _StdOut.putText("> ");
